...
from .views import index, historia, metodos_envio, nuestras_tiendas, preguntas_frecuentes, ayuda_contrasenia, login, pedidos, usuario, registro_bike, registro_usuario, seguimiento_envio, productos_servicios, contactanos, carritoCompras, servicios
